...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2025 at 03:49 PM
...
--
ALTER TABLE `concerts`
  MODIFY `id_concert` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `ticket_categories`
  MODIFY `id_ticket_category` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
